...
public class Trie{
    ...
    public void insert(String word) { // Inserir palavra
    ...
    public void insert(String[] wordList) { // Inserir palavras
        for (String word : wordList) {
            this.insert(word);
        }
    }
    public boolean search(String word) { // Procurar palavra
        HashMap<Character, TrieNode> children = root.getChildren();
        TrieNode node = null;
        for(int i = 0; i < word.length(); i++) {
            char character = word.charAt(i);
    ...
    public boolean find(String word) { // Encontrar palavra e checkar palavra
    ...
    public void remove(String word) { // Remover palavra
    ...
    public List<String> autocomplete(String word) { // Autocompletar Palavra
